...
INSTALLED_APPS = [
    ...
    # this is the middleware for serving static files in production, comment out if you want to use nginx to serve static files
...
# add trusted CDN
CSRF_TRUSTED_ORIGINS = [f"http://localhost:{os.getenv('NGINX_PORT', 80)}"] + os.getenv('CSRF_TRUSTED_ORIGINS', '').split(",")
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'spbackend','templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# for debugging without postgres
# if DEBUG:
#     DATABASES = {
#         'default': {
